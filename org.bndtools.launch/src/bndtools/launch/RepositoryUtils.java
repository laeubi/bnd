...
public class RepositoryUtils {
	...
	public static List<RepositoryPlugin> listRepositories(final Workspace localWorkspace, final boolean hideCache) {
		...
		// localWorkspace.getPlugins(RepositoryPlugin.class);
		...
		// !bndWorkspace.isDefaultWorkspace())
		// repos.add(Central.getWorkspaceRepository());
		//
		// // Add the repos from the provided workspace
		// for (RepositoryPlugin plugin : plugins) {
		// if ((plugin instanceof PopulatedRepository) && ((PopulatedRepository)
		// plugin).isEmpty()) {
		// continue;
		// }
		// if (hideCache == false ||
		// !Workspace.BND_CACHE_REPONAME.equals(plugin.getName())) {
		// repos.add(plugin);
		// }
		// }
		//
